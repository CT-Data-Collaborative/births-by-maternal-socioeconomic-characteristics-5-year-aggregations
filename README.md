Births by Maternal Socioeconomic Characteristics - 5-Year Aggregations

[![Build Status](https://travis-ci.org/CT-Data-Collaborative/births-by-maternal-socioeconomic-characteristics-5-year-aggregations.svg?branch=master)](https://travis-ci.org/CT-Data-Collaborative/births-by-maternal-socioeconomic-characteristics-5-year-aggregations)

Births by Maternal Socioeconomic Characteristics - 5-Year Aggregations reports the 3-year average number and percentage of births in certain categories by maternal background information (years of education and marital status).
